  ...
  return (
    <div className="App h-screen">
      ...
      <div className="flex border-2 border-black p-2 h-1/2 justify-center items-center content-center">
        <div className="flex flex-col border-2 border-red-400 m-3 h-4/5 w-2/3 text-center items-center">
          관심 있어요
        ...
        <div className="flex flex-col justify-between border-2 border-red-400 m-3 h-4/5 w-1/3 text-center content-center">
          ...
          ></input>
          <button
            className="border-2 border-red-200 m-2 items-end"
            onclick="alert('관심사를 추가했어요!')"
          >
            관심사 추가하기
          </button>
        </div>
      ...
      <div className="flex border-2 border-black p-2 h-1/2 justify-center items-center content-center">
        ...
        <div className="flex flex-col justify-between border-2 border-red-400 m-3 h-4/5 w-1/3 text-center content-center">
          <input
            type="text"
            name="search"
            className="border-2 border-red-200 h-4/5
           m-2 text-start"
            placeholder="약속 입력하기"
          ></input>
          <button
            className="border-2 border-red-200 m-2 items-end"
            onClick="alert('버튼을 클릭했군요!')"
          >
            약속 추가하기
          </button>
        </div>
